(function () {
    ...
    function common($location, $q, $rootScope, $timeout, logger) {
        ...
        function createSearchThrottle(viewmodel, list, filteredList, filter, delay) {
            // After a delay, search a viewmodel's list using a filter function, and return a filteredList.
            ...
            var filterFn = function () {
                // translates to ...
                // vm.filteredTopics = vm.topics.filter(function(item( { returns vm.topicFilter (item) } );
